  ...
  (0, _createClass2.default)(_ApiService, [{
    ...
    value: function loadSchema(entity) {
      ...
      if (typeof this.schemas[package_name] != 'undefined' && typeof this.schemas[package_name][class_name] != 'undefined') {
        ...
        $.get({
          url: _environment.environment.backend_url + '/index.php?get=model_schema&entity=' + entity,
          dataType: 'json',
          contentType: 'application/json; charset=utf-8'
        }).then(function (json_data) {
          if (typeof _this.schemas[package_name] == 'undefined') {
            _this.schemas[package_name] = {};
          }

          _this.schemas[package_name][class_name] = json_data;
          promise.resolve(_this.schemas[package_name][class_name]);
        });
      }
    ...
    value: function loadView(entity, view_id) {
      ...
      if (typeof this.views[package_name] != 'undefined' && typeof this.views[package_name][class_name] != 'undefined' && typeof this.views[package_name][class_name][view_id] != 'undefined') {
        ...
        $.get({
          ...
          if (typeof _this2.views[package_name] == 'undefined') {
            _this2.views[package_name] = {};
          }

          if (typeof _this2.views[package_name][class_name] == 'undefined') {
            _this2.views[package_name][class_name] = {};
          }

          _this2.views[package_name][class_name][view_id] = json_data;
          promise.resolve(_this2.views[package_name][class_name][view_id]);
        });
      }
    ...
    value: function loadTranslation(entity, lang) {
      ...
      if (typeof this.translations[package_name] != 'undefined' && typeof this.translations[package_name][class_name] != 'undefined' && typeof this.translations[package_name][class_name][lang] != 'undefined') {
        ...
        $.get({
          ...
          if (typeof _this3.translations[package_name] == 'undefined') {
            _this3.translations[package_name] = {};
          }

          if (typeof _this3.translations[package_name][class_name] == 'undefined') {
            _this3.translations[package_name][class_name] = {};
          }

          _this3.translations[package_name][class_name][lang] = json_data;
          promise.resolve(_this3.translations[package_name][class_name][lang]);
        });
      }
...
var Layout = function Layout(entity) {
...
var Model = /*#__PURE__*/function () {
  function Model(entity) {
    ...
    console.log(_equalServices.ApiService);
  }
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _equalServices.ApiService.getSchema('core\\User');

              case 2:
                schema = _context.sent;
                _context.next = 5;
                return _equalServices.ApiService.getView('symbiose\\inventory\\asset\\Product', 'create');
...
var eQ = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(eQ, null, [{
    ...
    value: function Collection(entity) {
      return new _equalLib.Model(entity);
    }
  }]);
  return eQ;
}();
...
( function( factory ) {
	if ( true ) {
		...
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery-exposed.js"), __webpack_require__(/*! ./version */ "./node_modules/jquery-ui/ui/version.js") ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
( function( factory ) {
	if ( true ) {
		...
		// AMD. Register as an anonymous module.
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery-exposed.js"), __webpack_require__(/*! ./version */ "./node_modules/jquery-ui/ui/version.js"), __webpack_require__(/*! ./escape-selector */ "./node_modules/jquery-ui/ui/escape-selector.js") ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else {}
...
( function( factory ) {
	if ( true ) {
		...
		// AMD. Register as an anonymous module.
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery-exposed.js"), __webpack_require__(/*! ./version */ "./node_modules/jquery-ui/ui/version.js"), __webpack_require__(/*! ./focusable */ "./node_modules/jquery-ui/ui/focusable.js") ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else {}
...
/******/ 	return __webpack_require__("./build/equal.js");
/******/ })()
;
//# sourceMappingURL=equal.bundle.js.map